    											...
    											if(data.length) {
    												...
    												if (studacadrecreqstatus == 0 || studacadrecreqstatus == 2 || studacadrecreqstatus == 8) {
    													tblstudent += "<tr>" + 
    															  ...
    															  "<td>" + value.SECTION + "</td>" +
    															  "<td>" + value.STATUS + "</td>" +
    															  "<td id='tdfinalaverage-" + value.STATUS + "-" + value.ID + "' name='" + value.ASS_ID + "'>" + parseFloat(final_stud_avg).toFixed(2).toString() + "%</td>" +
    															  "<td id='tdfinalstatus-" + value.STATUS + "-" + value.ID + "' name='" + value.ASS_ID + "'>" + final_stud_avg_status.toString() + "</td>" +
    															  "<td>" +
    															  "<button type='button' " +
    																"style='font-size: 11px;" +
    																"font-family: Roboto, sans-serif;" +
    																"font-weight: normal;' " +
    																"id='" + value.ID + "' name='" + value.ASS_ID + "' data-backdrop='static' data-keyboard='false' class='btn btn-success edit' value='" + value.ID + "'>" + 
    																"<span class='glyphicon glyphicon-edit'></span>Grades</button>" +
    															  "</td>" + 
    															  "</tr>";
    												...
    												tblstudent += "<tr>" + 
    															  ...
    															  "<td id='tdfinalstatus-" + value.STATUS + "-" + value.ID + "' name='" + value.ASS_ID + "'>NO ENCODED GRADES</td>" +
    															  "<td>" +
    															  "<button type='button' " +
    																"style='font-size: 11px;" +
    																"font-family: Roboto, sans-serif;" +
											...
											if(data.length) {
													$.each(parentid, function(key, value) {
														...
														tbl += "<table id='table-" + ReplaceSpecialCharacters(value.GSD_NAME) + "' class='table table-hover table-responsive table-bordered'>" + 
															   ...
															   "<tr>" +
															   "<th scope='col' colspan='" + (childid.length + 1) + "' style='text-decoration: underline;' id='th-" + ReplaceSpecialCharacters(value.GSD_CODE) + "-" + value.GS_ID + "-" + value.GSD_DET_ID + "' name='" + value.GSD_PERCENTAGE + "'>" + value.GSD_NAME + " (" + value.GSD_PERCENTAGE + " %)</th>" +							   
															   "</tr>" +
															   "<tr>";
																$.each(childid, function(k, v) {
																		tbl += "<th scope='col' id='th-" + ReplaceSpecialCharacters(v.GSD_CODE) + "-" + v.GS_ID + "-" + v.GSD_DET_ID + "' name='" + v.GSD_PERCENTAGE + "' style='padding: 0;margin: 0;'>" + v.GSD_CODE + " (" + v.GSD_PERCENTAGE + " %)</th>";
																});
														tbl += 	"<th scope='col' style='color: red; padding: 4 0 4 0;margin: 4 0 4 0;''>AVERAGE</th>";
														tbl += 	"</tr></thead>";
														tbl +=  "<tbody><tr>";
																$.each(childid, function(keys, v) {
																	tbl += "<td class='table-primary' style='font-size: 11px;font-family: Roboto, sans-serif;font-weight: normal;text-decoration: none;color: black;padding: 0;margin: 0; align: center;'>" + 
																			"<input type='text' id='txt-" + ReplaceSpecialCharacters(v.GSD_CODE) + "-" + v.GS_ID + "-" + v.GSD_DET_ID + "-" + v.GSD_PERCENTAGE + "-" + v.GSD_PARENT_ID + "' name='" + v.GSD_PERCENTAGE + "' style = 'font-size: 14px;text-align: center;padding: 0;margin: 0;' class='form-control' value='0' required='_required'/></td>";
																	txtinputvalue += "#txt-" + ReplaceSpecialCharacters(v.GSD_CODE) + "-" + v.GS_ID + "-" + v.GSD_DET_ID + "-" + v.GSD_PERCENTAGE + "-" + v.GSD_PARENT_ID + ",";
																})
														tbl += "<td rowspan='2' id='tdnext-" + ReplaceSpecialCharacters(value.GSD_CODE) + "-" + value.GS_ID + "-" + value.GSD_DET_ID + "-" + value.GSD_PERCENTAGE + "-" + value.GSD_PARENT_ID + "' style='font-size: 11px;font-family: Roboto, sans-serif;font-weight: normal;text-decoration: none;color: red;padding: 0;margin: 0;' class='table-primary'>" +
															   "0</td>";
														tbl += "</tr>";
														tbl += "<tr>";
																$.each(childid, function(keys, v) {
																	tbl += "<td id='tdsub-" + ReplaceSpecialCharacters(v.GSD_CODE) + "-" + v.GS_ID + "-" + v.GSD_DET_ID + "-" + v.GSD_PERCENTAGE + "-" + v.GSD_PARENT_ID + "' name='" + v.GSD_PERCENTAGE + "' class='table-primary' style='font-size: 11px;font-family: Roboto, sans-serif;font-weight: normal;text-decoration: none;color: red;padding: 0;margin: 0;'></td>";
									...
									success: function(result){
										...
										if (parseInt(_ret) == 0) {
											tdprocess += "<button " +
																	...
																	"text-decoration: none;" + 
																	"color: white;' " +
																	"id='btnsubmit-" + btnarrid[1] + "-" + _ret + "-"  + btnarrid[3] + "' class='btn btn-success btnsubmit' " +
																	"name='" + btnname + "'>Submit" +																
																"</button>";
											...
											tdprocess += "<button style='font-size: 10px;" +
																	...
																	"text-decoration: none;" + 
																	"color: white;' " +
																	"id='btnsubmit-" + btnarrid[1] + "-" + _ret + "-"  + btnarrid[3] + "' class='btn btn-danger btnsubmit' " +
																	"name='" + btnname + "'>Cancel" +																
																"</button>";
											...
											tdprocess += "<button " +
																...
																"text-decoration: none;" + 
																"color: white;' " +	
																"id='btnsubmit-" + btnarrid[1] + "-" + ret + "-"  + btnarrid[3] + "' class='btn btn-danger btnsubmit' " +
											...
											tdprocess += "<button " +
																...
																"text-decoration: none;" + 
																"color: white;' " +	
																"id='btnsubmit-" + btnarrid[1] + "-" + ret + "-"  + btnarrid[3] + "' class='btn btn-success btnsubmit' " +
																"name='" + btnname + "'>Submit" +																
															"</button>";
											coltdstatus.html('FOR SUBMISSION');
										}
		...
		$.ajax({
			...
			success: function(result)
			{
				...
				if(data.length) {
					...
					global_RESULTTYPE = '';
					$('#b-final-average').html('0%');
					$('#div-message').html("<p style='color: black; font-size: 12px; font-style: italic; font-weight: bold;'>No Record Found!</p>");
				}
			}
		});
	}
																	...
																	if (value.GS_ID > 0){
																		if (value.DEPT_APPROVER.length){
																			if (value.GS_PASS_SCORE.length <= 0 || value.GS_PASS_SCORE == '' || value.GS_PASS_SCORE == '0' || value.GS_PASS_SCORE == 0){
																					tblOffSubject += "<div style='font-size: 11px;" + 
																										   "font-family: Roboto, sans-serif;" + 
																										   "font-weight: normal;" + 
																										   "text-decoration: none;" + 
																										   "color: red;' " +
																				...
																				if (parseInt(value.NO_OF_STUDENT) == parseInt(value.NO_OF_ENCODED_STUDENT)){
																					if (value.REQ_STATUS == 0) { // Submit
																						tblOffSubject += "<button " +
																												...
																												"font-family: Roboto, sans-serif;" +
																												"font-weight: normal;' " +
																												"id='btnsubmit-" + value.SIGN_ID + "-" + value.REQ_STATUS + "-"  + value.SIGN_USERID + "' class='btn btn-success btnsubmit' " +
																						...
																						tblOffSubject += "<button " +
																												...
																												"text-decoration: none;" + 
																												"color: white;' " +	
																												"id='btnsubmit-" + value.SIGN_ID + "-" + value.REQ_STATUS + "-"  + value.SIGN_USERID + "' class='btn btn-danger btnsubmit' " +
																												"name='" + value.STUD_ACAD_REC_ID + "'>" + 
																												"Cancel" +																
																											"</button>";
																					...
																					// if(data.length) {
																						...
																						// if (studacadrecreqstatus == 0 || studacadrecreqstatus == 2 || studacadrecreqstatus == 8) {
																							// tblstudent += "<tr>" + 
																									  ...
																									  // "<td>" + value.SECTION + "</td>" +
																									  // "<td>" + value.STATUS + "</td>" +
																									  // "<td id='tdfinalaverage-" + value.STATUS + "-" + value.ID + "' name='" + value.ASS_ID + "'>" + final_stud_avg.toString() + "%</td>" +
																									  // "<td id='tdfinalstatus-" + value.STATUS + "-" + value.ID + "' name='" + value.ASS_ID + "'>" + final_stud_avg_status.toString() + "</td>" +
																									  // "<td>" +
																									  // "<button type='button' " +
																										// "style='font-size: 11px;" +
																		...
																		// success: function(result){
																			...
																			// $.ajax({
																				...
																				// success: function(result){
																					// var parentid = [];
																					// var childid = [];
																					// var ret = JSON.parse(result, function(key, value) { 
																						// if (value.GSD_PARENT_ID === "0" ) parentid.push(value); 
																						// return value;})
																					// var data = JSON.parse(result);
																					// var tbl = '';
																					...
																					// if(data.length) {
																							// $.each(parentid, function(key, value) {
																								// childid = [];
																								// JSON.parse(result, function(keys, val) { 
																								// if (val.GSD_PARENT_ID === value.GSD_DET_ID)childid.push(val);
																									// return val;})
																								// tbl += "<table id='table-" + ReplaceSpecialCharacters(value.GSD_NAME) + "' class='table table-hover table-responsive table-bordered'>" + 
																									   // "<thead class='table-primary'>" +
