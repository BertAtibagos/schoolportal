$(document).ready(function (){
	$('#btnAddComp').click(function(){ // add component
		...
		$('#div-new-gs-container').append(`
			<table class="table-borderless" id="table`+i+`" style="margin-bottom: 2rem;">
				<style>
					#gstbl {
						padding: 2px;
						vertical-align: top;
				...
				<tbody id="dynamicadd`+i+`">
					<tr>
						<td id="gstbl">
							<input type="text" class="form-control sl" name="id[]" id="id" value="`+i+`" readonly="" hidden>
						</td>
						<td id="gstbl">
							<input type="text" name="comp_name[]" id="comp_name`+i+`" class="form-control" placeholder="Component Name">
						</td>
						<td id="gstbl">
							<input type="text" name="comp_code[]" id="comp_code`+i+`" class="form-control" placeholder="Code">
						</td>
						<td id="gstbl">
							<input type="text" name="comp_desc[]" id="comp_desc`+i+`" class="form-control" placeholder="Description">
							<label>[Optional]</label>
						</td>
						<td id="gstbl">
							<input type="text" name="comp_percent[]" id="comp_percent`+i+`" class="form-control" placeholder="Percentage" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/^0[^.]/, '0');" maxlength="6">
						</td>
						<td class="col-md-1">
						</td>
						<td colspan='2' id="gstbl" style="text-align: end">
							<button type="button" id="btnAddSubComp" class="btn btn-success btnAddSubComp"><i class="fa fa-plus"></i></button>
							<button type="button" id="`+i+`" class="btn btn-warning remove_table"><i class="fa fa-trash-can" style="color: #ffffff;"></i></button>
						</td>
					</tr>
				</tbody>
			</table>
		...
		$(parentid).append(`
			<tr id="row`+tblid+rowCount+`">
				...
				<td id="gstbl">
					<input type="text" class="form-control sl2" name="id2`+tblid+`[]" id="id2" value="`+tblid+rowCount+`" readonly="" hidden>
				</td>
				<td id="gstbl">
					<input type="text" name="subcomp_name`+tblid+`[]" id="subcomp_name`+tblid+`" class="form-control sc`+tblid+rowCount+`" placeholder="Subcomponent Name">
				</td>
				<td id="gstbl">
					<input type="text" name="subcomp_code`+tblid+`[]" id="subcomp_code`+tblid+`" class="form-control sc`+tblid+rowCount+`" placeholder="Code">
				</td>
				<td id="gstbl">
					<input type="text" name="subcomp_desc`+tblid+`[]" id="subcomp_desc`+tblid+`" class="form-control sc`+tblid+rowCount+`" placeholder="Description">
					<label>[Optional]</label>
				</td>
				<td id="gstbl">
					<input type="text" name="subcomp_percent`+tblid+`[]" id="subcomp_percent`+rowCount+`" class="form-control sc`+tblid+rowCount+`" placeholder="%" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/^0[^.]/, '0');" maxlength="6">
				</td>
				<td colspan='2' id="gstbl" style="text-align: end">
					<button type="button" id="`+tblid+rowCount+`" class="btn btn-danger remove_row"><i class="fa fa-trash-can" style="color: #ffffff;"></i></button>
				</td>
			</tr>
		`);
	...
	$('#btnSubmitTag').click(function(){
		...
		var gscaleid = gscaleid.slice(1,-1);
		...
		if(subjid.length){
			$.ajax({
				...
				success: function(data){
					...
					$("#div-message").html("Subject Taggin Successful!");
					$("#div-message").fadeIn();
					$("#div-message").delay(10000).fadeOut();
				}
			});
