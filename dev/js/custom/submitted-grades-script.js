$(document).ready(function(){
	...
	function GetAcademicLevel(_type)
	{
	    try {
    		$.ajax({
    			type: 'GET',
    			url: '../../model/forms/submittedgrades/submitted-grades-controller.php',
    			data:{
    				type : _type
    			},
								...
								forapprovalreqlist += "<tr>" +
												...
												"<td>" +
													"<button type='button' " +
														...
														"font-family: Roboto, sans-serif;" +
														"font-weight: normal;' " +
														"id='btngradingscale-" + value.OFFERED_SUBJ_SMS_ID + "-"  + value.GS_ID + "-" + value.STATUS + "' name='" + value.STUD_REC_ID + "' data-backdrop='static' data-keyboard='false' class='btn btn-block btn-primary btnviewstudent'>" + 
												...
												"<td>" +
													"<button type='button' " +
														...
														"font-family: Roboto, sans-serif;" +
														"font-weight: normal;' " +
														"id='btnmainprocessapproved-" + value.OFFERED_SUBJ_SMS_ID + "-"  + value.GS_ID + "-" + value.STATUS + "' name='" + value.STUD_REC_ID + 
														"' data-backdrop='static' data-keyboard='false' class='btn btn-success btn-primary btnmainprocessapproved'>" + 
													...
													"<button type='button' " +
														...
														"font-family: Roboto, sans-serif;" +
														"font-weight: normal;' " +
														"id='btnmainprocessdenied-" + value.OFFERED_SUBJ_SMS_ID + "-"  + value.GS_ID + "-" + value.STATUS + "' name='" + value.STUD_REC_ID + 
														"' data-backdrop='static' data-keyboard='false' class='btn btn-danger btn-primary btnmainprocessdenied'>" + 
														"<span class='glyphicon glyphicon-edit'></span>" +
															"Denied" + 
													"</button>" +
												"</td>" +
													...
													if (value.RECORDS.length > 0) {																											
														...
														tblstudent += "<tr>" + 
																  ...
																  "<button type='button' " +
																	...
																	"font-family: Roboto, sans-serif;" +
																	"font-weight: normal;' " +
																	"id='" + value.ID + "' name='" + value.ASS_ID + "' data-backdrop='static' data-keyboard='false' class='btn btn-block btn-primary edit' value='" + value.ID + "'>" + 
																	"<span class='glyphicon glyphicon-edit'></span>Grades</button>" +
																  "</td>" + 
																  "</tr>";
													} else {
														...
														if(data.length) {
															$.each(data, function(key, value) {
																if (value.GSD_PARENT_ID.search(regex) != -1){
																	tbl += "<table id='table-" + value.GSD_NAME + "' class='table table-hover table-responsive table-bordered'>" + 
																		   "<thead class='table-primary'>" +
																		   "<tr>" +
																		   "<th scope='col' colspan='5' style='text-decoration: underline;' id='th-" + value.GSD_CODE + "-" + value.GS_ID + "-" + value.GSD_DET_ID + "' name='" + value.GSD_PERCENTAGE + "'>" + value.GSD_NAME + " (" + value.GSD_PERCENTAGE + " %)</th>" +							   
																		   "</tr>" +
																		   "<tr>";
																			$.each(data, function(keys, val) {
																				var regex1 = new RegExp(value.GSD_DET_ID,'i');
																				if (val.GSD_PARENT_ID.search(regex1) != -1){
																					tbl += "<th scope='col' id='th-" + val.GSD_CODE + "-" + val.GS_ID + "-" + val.GSD_DET_ID + "' name='" + val.GSD_PERCENTAGE + "' style='padding: 0;margin: 0;'>" + val.GSD_CODE + " (" + val.GSD_PERCENTAGE + " %)</th>";
																				}
																			});
																			...
																			$.each(data, function(k, v) {
																			   ...
																			   if (v.GSD_PARENT_ID.search(regex2) != -1){
																					tbl += "<td class='table-primary' style='font-size: 11px;font-family: Roboto, sans-serif;font-weight: normal;text-decoration: none;color: black;padding: 0;margin: 0; align: center;'>" + 
																						"<input type='text' id='txt-" + v.GSD_CODE + "-" + v.GS_ID + "-" + v.GSD_DET_ID + "-" + v.GSD_PERCENTAGE + "-" + v.GSD_PARENT_ID + "' name='" + v.GSD_PERCENTAGE + "' style = 'font-size: 14px;text-align: center;padding: 0;margin: 0;' class='form-control' value='0' required disabled/></td>";
																					gtxtinputvalue = "#txt-" + v.GSD_CODE + "-" + v.GS_ID + "-" + v.GSD_DET_ID + "-" + v.GSD_PERCENTAGE + "-" + v.GSD_PARENT_ID + ",";
																					global_txtinputvalueid += gtxtinputvalue;
																			   }
																			});
																	tbl += "<td rowspan='2' id='tdnext-" + value.GSD_CODE + "-" + value.GS_ID + "-" + value.GSD_DET_ID + "-" + value.GSD_PERCENTAGE + "-" + value.GSD_PARENT_ID + "' style='font-size: 11px;font-family: Roboto, sans-serif;font-weight: normal;text-decoration: none;color: red;padding: 0;margin: 0;' class='table-primary'>" +
																		   "0</td>";
																	tbl += "</tr>";
																	tbl += "<tr>";
																			$.each(data, function(k1, v1) {
																			   ...
																			   if (v1.GSD_PARENT_ID.search(regex3) != -1){
																				   tbl += "<td id='tdsub-" + v1.GSD_CODE + "-" + v1.GS_ID + "-" + v1.GSD_DET_ID + "-" + v1.GSD_PERCENTAGE + "-" + v1.GSD_PARENT_ID + "' name='" + v1.GSD_PERCENTAGE + "' class='table-primary' style='font-size: 11px;font-family: Roboto, sans-serif;font-weight: normal;text-decoration: none;color: red;padding: 0;margin: 0;'></td>";
