...
include '../../configuration/connection-config.php';
    ...
    if(isset($_POST['gscale_name']) 
        ...
        && isset($_POST['comp_code'])
        && isset($_POST['comp_desc'])
        && isset($_POST['comp_percent'])
        && isset($_POST['sc'])){
      ...
      $subcomp = $_POST['sc'];
      // echo '<script>alert("All variables are imported via AJAX")</script>';
      ...
      if($gscale_code !== ''
        ...
        // echo '<script>alert("There are NO BLANK INPUTS.")</script>';
