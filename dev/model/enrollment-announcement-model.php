<div class="mt-4 bg-primary bg-opacity-25 border border-primary border-3 rounded p-2">
    <?php
        ...
        if(str_contains($_SERVER['REQUEST_URI'], "login-model")){
            ...
            // <a href='../../onlineregistration/online-campus/php/partials/main-registration.php?account_id=".$_SESSION['SYSUSERID']."&last_name=".$_SESSION['LASTNAME']."&first_name=".$_SESSION['FIRSTNAME']."&middle_name=".$_SESSION['MIDDLENAME']."&suffix_name=".$_SESSION['SUFFIXNAME']."&student_type=".$_SESSION['STUDENT_TYPE']."&student_id=".$_SESSION['USERID']."&emailaddress=".$_SESSION['EMAILADDRESS']."&lvlid=".$_SESSION['LVLID']."' target='_blank'>
            echo "
            <div class='row'>
