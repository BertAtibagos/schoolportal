				...
				<div class="col col-md-1 col-xl-1 px-sm-0 offcanvas offcanvas-start" id="demo"
					...
					<style>
						...
						<ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-sm-start" id="mnu-main">
							...
							<li class="nav-item" id="mnu-tadi-reporting" style="width: -webkit-fill-available;">
								<a href="" id="user-tadi-reporting" class="main nav-link px-0 align-middle" style="color:white; border-radius:0px" data-bs-toggle="tab"><span class="ms-1  d-sm-inline"><i class="fa-regular fa-rectangle-list" style="margin-left:10px" ></i>&nbsp &nbspTadi - Reporting</span></a>
							</li>
