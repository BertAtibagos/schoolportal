async function dashBoardContent(){
    ...
    try{
        ...
        const totalStatsRequest = await fetch(`tadi/humanresource/controller/index-post.php`,{
            method: "POST",
        ...
        const fetchMonthlyTotalRequest = await fetch(`tadi/humanresource/controller/index-post.php`,{
            method: "POST",
            headers: {"Content-Type": "application/x-www-form-urlencoded"},
            body: new URLSearchParams({
        ...
        const fetchDeptTotalRequest = await fetch(`tadi/humanresource/controller/index-post.php`,{
            method: "POST",
            headers: {"Content-Type": "application/x-www-form-urlencoded"},
            body: new URLSearchParams({
        ...
        const fetchPerCutOffTotalRequest = await fetch(`tadi/humanresource/controller/index-post.php`,{
            method: "POST",
            headers: {"Content-Type": "application/x-www-form-urlencoded"},
            body: new URLSearchParams({
...
async function summaryGenReport(){
    ...
    try{
        ...
        const request = await fetch(`tadi/humanresource/controller/index-post.php`, {
            method: "POST",
            headers: {"Content-Type": "application/x-www-form-urlencoded"},
            body: params
        });
